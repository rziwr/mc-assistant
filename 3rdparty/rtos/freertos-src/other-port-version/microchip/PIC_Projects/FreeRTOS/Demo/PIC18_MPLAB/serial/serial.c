...
unsigned long ulBaud;
	...
	portENTER_CRITICAL();
	{
	    ...
	    //ANSELC = 0; /* make Port C Digital I/O */
        /* make IO pins digital I/O */
        //ANSELCbits.ANSC6 = 0;
        //ANSELCbits.ANSC7 = 0;
        ...
        /* Open1USART */
        Open1USART(USART_TX_INT_ON & USART_RX_INT_ON & USART_ASYNCH_MODE & USART_EIGHT_BIT & USART_CONT_RX & USART_BRGH_LOW, 15);
